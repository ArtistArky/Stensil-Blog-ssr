...
const Card2: FC<Card2Props> = ({
  ...
  return (
    ...
    >
      ...
      <Link to={href} onClick={() => setcurrentPost(currentPost)} className="absolute inset-0" />
      ...
      <div className="p-4 sm:p-5 flex flex-col">
        <div className="space-y-3">
          ...
          >
            <Link to={href} onClick={() => setcurrentPost(currentPost)} className="line-clamp-2" title={title}>
              {title}
            </Link>
          </h2>
